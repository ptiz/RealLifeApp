...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var appController: AppController = {
        return AppController( dataController: self.dataController, friendfeed: self.friendFeed)
    }()
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        self.appController.feedReadySlot <+> (NSStringFromClass(viewController.dynamicType), viewController.updateHeader)
